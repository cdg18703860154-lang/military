...
const routes: Array<{
  ...
  { path: "", changeFrequency: "daily", priority: 1, lastModified: "2026-09-12" },
  { path: "/codes", changeFrequency: "daily", priority: 0.95, lastModified: "2026-09-12" },
  { path: "/tier-list", changeFrequency: "weekly", priority: 0.9, lastModified: "2026-09-09" },
  { path: "/trello", changeFrequency: "weekly", priority: 0.72, lastModified: "2026-09-12" },
  ...
  { path: "/guides/getting-started", changeFrequency: "weekly", priority: 0.78, lastModified: "2026-09-12" },
  { path: "/guides/how-to-get-cash", changeFrequency: "weekly", priority: 0.78, lastModified: "2026-09-12" },
  ...
  { path: "/wiki/squads", changeFrequency: "weekly", priority: 0.78, lastModified: "2026-09-12" },
  ...
  { path: "/updates", changeFrequency: "daily", priority: 0.75, lastModified: "2026-09-12" },
  { path: "/sources", changeFrequency: "monthly", priority: 0.5, lastModified: "2026-09-12" },
