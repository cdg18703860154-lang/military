...
const steps: GuideStep[] = [
  ...
  { title: "Use code Cash to remove a bottleneck", body: <p>Check the <Link href="/codes/">current code status</Link> before including a code reward in your budget. Count only Cash the game actually grants. Use it for the next visible progression requirement, and keep enough available to recover from an unsuccessful attempt. A reported reward is not guaranteed income until your account receives it.</p> },
