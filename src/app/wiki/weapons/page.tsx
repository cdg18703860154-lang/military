/* RB-AUTO-ASSET family=entity receipt=ef81d0107433448369957a9ff495c5449fafbd7284435ee631338e7a378c6af4 content=bfba8287287e14751ee5dcf4168f5cfd01065ca161888721fc47df877debe64f */
...
const entityPage = {
  "route": "/wiki/weapons",
  "title": "Military Army Tycoon Weapons Wiki",
  "headline": "Military Army Tycoon Weapons",
  "answer": "Current exact-game visuals with checked evidence support the labels Glock-17 and AK-47 Rifle, and The page does not invent a full arsenal, damage, fire rate, price, or weapon tier when those fields are absent. Checked Weapons terms: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
  "entities": [
    {
      "id": "weapon-system",
      "name": "Weapons",
  ...
  "facts": [
    {
      "id": "fact:weapon-system:overview",
      "subjectRef": "weapon-system",
      "predicate": "overview",
      "label": "Overview",
      "rawValue": "Current exact-game visuals support the labels Glock-17 and AK-47 Rifle. The page does not invent a full arsenal, damage, fire rate, price, or weapon tier when those fields are absent.",
      "value": "Current exact-game visuals support the labels Glock-17 and AK-47 Rifle. The page does not invent a full arsenal, damage, fire rate, price, or weapon tier when those fields are absent."
    }
  ],
  "relations": [
    {
      "id": "relation:weapon-system:parent",
      "fromRef": "weapon-system",
      "fromName": "Weapons",
      "type": "belongs to",
      "toRef": "military-base",
    ...
    {
      "id": "relation:weapon-system:task",
      "fromRef": "weapon-system",
      "fromName": "Weapons",
      "type": "used in",
      "toRef": "army-combat",
  ...
  "internalLinks": [
    {
      "href": "/wiki",
      "label": "browse squad and base notes",
      "context": "The weapon family must return to its parent and related mechanics.",
      "relationRef": ""
    },
    {
      "href": "/tier-list",
      "label": "best-weapon evidence method",
      "context": "Best-weapon visitors need the comparison methodology rather than unsupported performance claims.",
      "relationRef": ""
    },
    {
      "href": "/sources",
      "label": "review the missing weapon data",
      "context": "Screenshot-led labels and withheld stats require clear provenance.",
      "relationRef": ""
    }
  ],
  "modules": [
  ...
  "claimIds": [
    "fact-weapons-visible"
  ],
  "experienceIds": [
    "experience:wiki-weapons"
  ],
  "gameVisual": {
  ...
  "generatedBlocks": [
    {
      "id": "wiki-weapons-fact-1",
      "kind": "fact",
      "heading": "Checked detail 1",
      "body": "For Weapons, current exact-game visual evidence shows the weapon labels Glock-17 and AK-47 Rifle, but it does not establish complete weapon stats, prices, or a full arsenal, with checked anchors: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
    ...
    {
      "id": "wiki-weapons-steps",
      "kind": "steps",
      "heading": "Apply the evidence in the live game",
      "body": "Use the checked Roblox screen as the final confirmation. For Weapons, current exact-game visual evidence shows the weapon labels Glock-17 and AK-47 Rifle, but it does not establish complete weapon stats, prices, or a full arsenal, with checked anchors: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
    ...
    {
      "id": "wiki-weapons-stuck-help",
      "kind": "stuckHelp",
      "heading": "If your screen looks different",
      "body": "Return to the named exact-game source before changing the conclusion. For Weapons, current exact-game visual evidence shows the weapon labels Glock-17 and AK-47 Rifle, but it does not establish complete weapon stats, prices, or a full arsenal, with checked anchors: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
    ...
    },
    {
      "id": "wiki-weapons-faq",
      "kind": "faq",
      "heading": "What does the Weapons evidence confirm?",
      "body": "Confirm this answer against the dated source. For Weapons, current exact-game visual evidence shows the weapon labels Glock-17 and AK-47 Rifle, but it does not establish complete weapon stats, prices, or a full arsenal, with checked anchors: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
    ...
    {
      "id": "wiki-weapons-source-notes",
      "kind": "sourceNotes",
      "heading": "Where this answer comes from",
      "body": "Read the dated source record before relying on a current detail. For Weapons, current exact-game visual evidence shows the weapon labels Glock-17 and AK-47 Rifle, but it does not establish complete weapon stats, prices, or a full arsenal, with checked anchors: Glock-17, AK-47 Rifle, no complete weapon stats, no complete arsenal.",
  ...
  "leadHeading": "Weapons: the checked answer",
  ...
  "breadcrumbs": [
    ...
    {
      "name": "Military Army Tycoon Weapons Wiki",
      "href": "/wiki/weapons"
    }
  ],
...
<nav data-asset-module="related-entities" aria-label="Related knowledge" className="mt-10 content-card">
    ...
    <p data-relation-ref="">The weapon family must return to its parent and related mechanics.: <Link href="/wiki">browse squad and base notes</Link></p>
    <p data-relation-ref="">Best-weapon visitors need the comparison methodology rather than unsupported performance claims.: <Link href="/tier-list">best-weapon evidence method</Link></p>
    <p data-relation-ref="">Screenshot-led labels and withheld stats require clear provenance.: <Link href="/sources">review the missing weapon data</Link></p>
        </div>
      </nav>
