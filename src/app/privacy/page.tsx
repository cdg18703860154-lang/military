    ...
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-4">
        ...
        <article className="content-card">
          ...
          <p className="mt-2 leading-7 text-white/68">
            Use the public issue tracker linked from the contact page for privacy questions or rights
            requests. Do not post account details, payment information, private contact details, or other
