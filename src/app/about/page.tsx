...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <section className="content-card"><h2>Who maintains the site</h2><p>The site owner and editorial team are responsible for source selection, content decisions, corrections, and publication. A real editor or team name will be displayed only when the owner chooses to publish it. The site does not invent a military expert, Roblox tester, or author profile.</p><p><strong>Current editorial record:</strong> researched and reviewed by the site editorial team; last fact-checked September 6, 2026.</p></section>
