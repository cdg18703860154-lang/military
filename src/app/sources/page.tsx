...
export default function SourcesPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <PageIntro eyebrow="Independent editorial policy" title="Sources and Editorial Method" description="Military Army Tycoon Wiki covers Battle Action's Roblox experience at Place ID 95409544559668. It is not operated by Roblox or Battle Action. The goal is to answer player tasks without mixing in similarly named games." />
