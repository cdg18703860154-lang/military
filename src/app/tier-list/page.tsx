...
export default function TierListPage() {
  return (
    <GuideArticle
      eyebrow="Comparison status • reviewed September 9, 2026"
      ...
      faq={faq}
      sourceNotes={<><section><h2>Evidence boundary</h2><p> Pistol, Rifle, and SMG labels are confirmed; role descriptions are secondary and dated. Formation artwork is not ranking evidence.</p></section><nav aria-label="Related guides"><h2>Related guides</h2><p>Review the underlying <Link href="/wiki/squads/" className="font-bold text-cyan-300">squad records</Link>, test commands in <Link href="/wiki/orders/" className="font-bold text-cyan-300">Orders</Link>, or build a goal-based plan with the <Link href="/army-builder/" className="font-bold text-cyan-300">Army Mission Planner</Link>.</p></nav></>}
